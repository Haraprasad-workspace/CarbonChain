...
const AssignLogistics = () => {
  ...
  return (
    <div
      ref={pageRef}
      className="min-h-screen bg-[#FFFBF5] font-['Montserrat',sans-serif] text-[#422D0B] p-4 sm:p-8 max-w-5xl mx-auto space-y-6 selection:bg-[#FFA800] selection:text-[#422D0B]"
    >
      {/* Back Navigation */}
      <div>
        <button
      ...
      <header className="bg-white border border-[#E8DDCB] rounded-3xl p-6 sm:p-8 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-5">
        <div className="space-y-2">
          ...
          <p className="text-xs font-medium text-[#967A53] leading-relaxed max-w-xl">
            Assign a verified transport partner to collect and deliver this
            waste shipment safely to its target facility.
          </p>
        </div>
      ...
      <section className="bg-white border border-[#E8DDCB] rounded-3xl p-5 sm:p-6 shadow-2xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <span className="px-3 py-1.5 rounded-full bg-amber-50 border border-[#FFA800]/30 text-[#422D0B] text-[9px] font-bold w-fit">
