...
const CarbonList = () => {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 font-sans">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div
            key={item}
            className="bg-[#FFFBF5] border border-[#E8DDCB] rounded-2xl p-6 space-y-4 animate-pulse shadow-sm"
          >
            <div className="flex justify-between items-center">
              <div className="h-4 w-28 bg-[#E8DDCB] rounded-full" />
              <div className="h-4 w-16 bg-[#E8DDCB]/60 rounded-full" />
            </div>
            <div className="h-16 bg-[#FFFBF5] border border-[#E8DDCB] rounded-xl" />
            <div className="grid grid-cols-2 gap-3">
              <div className="h-10 bg-[#E8DDCB]/50 rounded-xl" />
              <div className="h-10 bg-[#E8DDCB]/50 rounded-xl" />
            </div>
          </div>
        ))}
  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-2xl p-6 font-sans flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#FFA800] hover:bg-[#FFC24A] text-[#422D0B] font-black text-xs rounded-xl transition-all cursor-pointer shadow-sm hover:shadow"
        >
          Try Again
        </button>
      </div>
  ...
  if (records.length === 0) {
    return (
      <div className="bg-[#FFFBF5] border border-[#E8DDCB] border-dashed rounded-3xl p-10 font-sans text-center space-y-3">
        <div className="w-12 h-12 rounded-2xl bg-white border border-[#E8DDCB] flex items-center justify-center text-[#FFA800] text-xl font-black mx-auto shadow-sm">
          🌱
        </div>
        <div className="space-y-1">
